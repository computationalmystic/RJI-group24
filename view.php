...
-->
    ...
    <label for=range1>Slide, then press "Search to search for graded photos"</label> <br><br>
<span>0 </span><input type="range" id="slide1" min="0" max="10" value=0 step=0.1 onchange="printValue('slide1', 'rangeValue1')"><span> 10 </span>
    <div> <br>

...
<header class="w3-container w3-red w3-center" style="padding:128px 16px">
  ...
  <p class="w3-xlarge">Click below to upload a photo to be graded</p>
...
if(move_uploaded_file($_FILES['file']['tmp_name'][$i], $target)) {
  ...
  echo "The file ". basename( $file). " has been uploaded, and your information has been added to the directory";
	$title= basename($file);
